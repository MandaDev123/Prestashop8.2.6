...
class __TwigTemplate_872c5428b5359aecbc74cb004f990d51 extends Template
{
    private $source;
    private $macros = [];
      ...
      <div class=\"card-body\">
        ...
        <div class=\"alert alert-danger d-none\" role=\"alert\" id=\"customerRequiredFieldsAlertMessageOptin\">
          <div class=\"alert-text\">
            <p>";
        // line 43
        echo $this->extensions['PrestaShopBundle\Twig\RawPurifiedExtension']->rawPurifier($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("[1]Make[/1] sure you enable partner offers in the [2]Shop Parameters > Customer Settings[/2] section of the back office before requiring them. Otherwise, new customers won't be able to create an account and [1]proceed[/1] to checkout.", ["[1]" => "<strong>", "[/1]" => "</strong>", "[2]" => (("<a href=\"" . $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_customer_preferences")) . "\">"), "[/2]" => "</a>"], "Admin.Orderscustomers.Help"));
        // line 48
        echo "</p>
          </div>
        </div>
