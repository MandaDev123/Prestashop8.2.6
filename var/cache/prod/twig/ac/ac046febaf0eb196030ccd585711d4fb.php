...
class __TwigTemplate_8eb9cb735416c791304b3ad15c43f303 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        <div class=\"card-body\">
          <div class=\"row\">
            ...
            // line 45
            echo "              ";
            echo $this->extensions['PrestaShopBundle\Twig\RawPurifiedExtension']->rawPurifier(twig_sprintf($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("for a total amount of %s", [], "Admin.Orderscustomers.Feature"), ($context["totalAmount"] ?? null)));
            echo "
            </div>
            <div class=\"col\">
              ";
