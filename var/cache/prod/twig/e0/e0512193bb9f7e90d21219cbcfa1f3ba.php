...
class __TwigTemplate_d7a5d5b18c4b07e41770eae69567d61d extends Template
{
    private $source;
    private $macros = [];
...
($context["orderForViewing"] ?? null), "id", [], "any", false, false, false, 168)]));
    ...
    ";
      ...
      <small>
        ";
        // line 242
        echo $this->extensions['PrestaShopBundle\Twig\RawPurifiedExtension']->rawPurifier($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("For this customer group, prices are displayed as: [1]%tax_method%[/1]", ["%tax_method%" => twig_get_attribute($this->env, $this->source,         // line 243
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Sell/Order/Order/Blocks/View/products.html.twig", "C:\\xampp\\htdocs\\Prestashop\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Sell\\Order\\Order\\Blocks\\View\\products.html.twig");
    }
}
