...
class __TwigTemplate_f10a0790327af65ae18d45176616305c extends Template
{
    private $source;
    private $macros = [];
  ...
  ";
      ...
      <div class=\"col-sm-6 col-md-8 col-lg-9 pl-0\">
        <p class=\"mb-0\">
          ";
                // line 39
                echo $this->extensions['PrestaShopBundle\Twig\RawPurifiedExtension']->rawPurifier(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["module"], "attributes", [], "any", false, false, false, 39), "displayName", [], "any", false, false, false, 39));
                echo "
        ...
        <p class=\"text-muted\">
          ";
                // line 45
                echo $this->extensions['PrestaShopBundle\Twig\RawPurifiedExtension']->rawPurifier(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["module"], "attributes", [], "any", false, false, false, 45), "description", [], "any", false, false, false, 45));
                echo "
        </p>
      </div>
      ";
