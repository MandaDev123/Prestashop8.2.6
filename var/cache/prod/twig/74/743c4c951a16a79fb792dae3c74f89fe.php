...
class __TwigTemplate_972b12e5786dabca364cb8d70a6fd082 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block__form_order_states_entry_label($context, array $blocks = [])
    {
      ...
      <label";
        ...
        <span class=\"status-name\">";
            // line 74
            echo (( !(($context["label"] ?? null) === false)) ? ($this->extensions['PrestaShopBundle\Twig\RawPurifiedExtension']->rawPurifier(($context["label"] ?? null))) : (""));
            // line 75
            echo "</span>
      </label>
    </div>
