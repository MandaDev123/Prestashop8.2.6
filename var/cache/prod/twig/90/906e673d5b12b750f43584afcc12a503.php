...
class __TwigTemplate_b002544941f323f477c7a6acf7e3afbe extends Template
{
    private $source;
    private $macros = [];
        ...
        ";
            ...
            <div class=\"module-import-start\">
              ...
              <p class=\"module-import-start-main-text\">
                ";
            // line 45
            echo $this->extensions['PrestaShopBundle\Twig\RawPurifiedExtension']->rawPurifier(twig_replace_filter($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Drop your module archive here or [1]select file[/1]", [], "Admin.Modules.Feature"), ["[1]" => "<a href=\"#\" class=\"module-import-start-select-manual\">", "[/1]" => "</a>"]));
            echo "
              </p>
